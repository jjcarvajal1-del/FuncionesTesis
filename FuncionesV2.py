...
def pushover(Vfy, VEs,Vfc_vigas,VEc_vigas,Vfc_columnas,VEc_columnas,Vb1,Vh1,Vb2,Vh2,Vrec,VWentrepiso,VWcubierta,VWviva):
    ...
    fy=Vfy*MPa        # Límite elástico
    Es=VEs*GPa        # Módulo de elasticidad
    ...
    #2.Concreto para zona inconfinada usando el modelo Concrete02 - f'c= Vfc_vigas MPa
    k2=1.00                    # Factor de confinamiento de Mander
    fc2=-Vfc_vigas*MPa         # Resistencia a la compresión inconfinada
    fck2=k2*fc2                # Resistencia a la compresión característica
    Ec2=VEc_vigas*MPa          # Módulo de elasticidad del concreto
    ...
    #3.Concreto para zona confinada usando el modelo Concrete02 - f'c= Vfc_vigas MPa
    k3=1.25                    # Factor de confinamiento de Mander
    fc3=-Vfc_vigas*MPa         # Resistencia a la compresión inconfinada
    fck3=k3*fc3                # Resistencia a la compresión característica
    Ec3=VEc_vigas*MPa          # Módulo de elasticidad del concreto
    epsc03=-0.002              # Deformación unitaria en resistencia máxima
    fpcu3=-0.25*fc3            # Resistencia última a compresión
    epscu3=-0.010              # Deformación unitaria en resistencia última
    lambdaC3=0.1               # Pendiente post pico tensil
    ft3=0.1*fc3                # Resistencia a tracción(10%*f'c)
    Ets3=0.02*Ec3              # Módulo de elasticidad en tracción(2%*Ec)
    ops.uniaxialMaterial('Concrete02', 3, fck3, epsc03, fpcu3, epscu3, lambdaC3,ft3,Ets3)
    #4.Concreto para zona inconfinada usando el modelo Concrete02 - f'c= Vfc_columnas MPa
    k4=1.00                    # Factor de confinamiento de Mander
    fc4=-Vfc_columnas*MPa      # Resistencia a la compresión inconfinada
    fck4=k4*fc4                # Resistencia a la compresión característica
    Ec4=VEc_columnas*MPa       # Módulo de elasticidad del concreto
    ...
    #5.Concreto para zona confinada usando el modelo Concrete02 - f'c= Vfc_columnas MPa
    k5=1.25                    # Factor de confinamiento de Mander
    fc5=-Vfc_columnas*MPa      # Resistencia a la compresión inconfinada
    fck5=k5*fc5                # Resistencia a la compresión característica
    Ec5=VEc_columnas*MPa       # Módulo de elasticidad del concreto
    epsc05=-0.002              # Deformación unitaria en resistencia máxima
    fpcu5=-0.25*fc5            # Resistencia última a compresión
    epscu5=-0.010              # Deformación unitaria en resistencia última
    lambdaC5=0.1               # Pendiente post pico tensil
    ft5=0.1*fc5                # Resistencia a tracción(10%*f'c)
    Ets5=0.02*Ec5              # Módulo de elasticidad en tracción(2%*Ec)
    ops.uniaxialMaterial('Concrete02', 5, fck5, epsc05, fpcu5, epscu5, lambdaC5,ft5,Ets5)
    print("Materiales definidos exitosamente")
    #1.Sección de viga concreto rectangular maciza con dimensiones b1 x h1 y refuerzo superior e inferior 4 barras #5 y estribos #3
    b1=Vb1*m                   # Ancho de la sección trasversal 1
    h1=Vh1*m                   # Alto de la sección transversal 1
    rec1=Vrec*mm               # Recubrimiento de concreto
    ...
    seccion1=[['section', 'Fiber', 1,'-GJ',G*J],
            ...
            ['layer', 'straight', 1, 4, AbarNo5, -nb1/2+DbarNo3+DbarNo5/2,nh1/2-DbarNo3-DbarNo5/2,nb1/2-DbarNo3-DbarNo5/2,nh1/2-DbarNo3-DbarNo5/2],       # Refuerzo superior
            ['layer', 'straight', 1, 4, AbarNo5, -nb1/2+DbarNo3+DbarNo5/2,-nh1/2+DbarNo3+DbarNo5/2,nb1/2-DbarNo3-DbarNo5/2,-nh1/2+DbarNo3+DbarNo5/2]]     # Refuerzo inferior
    #2.Sección 2 - columna concreto rectangular maciza con dimensiones b2 x h2 y refuerzo de 12 barras #5 y estribos #3 
    b2=Vb2*m                   # Ancho de la sección trasversal 2
    h2=Vh2*m                   # Alto de la sección transversal 2
    rec2=Vrec*mm               # Recubrimiento de concreto
    ...
    seccion2=[['section', 'Fiber', 2,'-GJ',G*J],
            ...
            ['layer', 'straight', 1, 4, AbarNo5, -nb2/2+DbarNo3+DbarNo5/2,nh2/2-DbarNo3-DbarNo5/2,nb2/2-DbarNo3-DbarNo5/2,nh2/2-DbarNo3-DbarNo5/2],     # Refuerzo superior
            ['layer', 'straight', 1, 2, AbarNo5, -nb2/2+DbarNo3+DbarNo5/2,nh2/2-nh2/3,nb2/2-DbarNo3-DbarNo5/2,nh2/2-nh2/3],                             # Refuerzo fila 2
            ['layer', 'straight', 1, 2, AbarNo5, -nb2/2+DbarNo3+DbarNo5/2,-nh2/2+nh2/3,nb2/2-DbarNo3-DbarNo5/2,-nh2/2+nh2/3],                           # Refuerzo fila 3
            ['layer', 'straight', 1, 4, AbarNo5, -nb2/2+DbarNo3+DbarNo5/2,-nh2/2+DbarNo3+DbarNo5/2,nb2/2-DbarNo3-DbarNo5/2,-nh2/2+DbarNo3+DbarNo5/2]]   # Refuerzo fila inferior
    # DEFINICIÓN DE NODOS
    #NODOS PISO 1
    ...
    Wentrepiso = VWentrepiso*kN/m**2
    Wcubierta = VWcubierta*kN/m**2
    Wviva = VWviva*kN/m**2
    ...
    dU= 0.5*mm                      # Incremento de desplazamiento por paso
    ...
    ops.test('NormDispIncr', 1.0e-4, 25)
